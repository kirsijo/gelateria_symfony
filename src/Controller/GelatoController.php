...
class GelatoController extends AbstractController
{
    ...
    public function flavour(string $slug = null): Response
    {
        ...
        $flavours = [
            'pistachio' => ['flavour' => 'pistachio', 'image'=>'https://www.davidlebovitz.com/wp-content/uploads/2007/09/1314787147_c9ac9d5bae_o-1.jpg', 'description' => 'Pistachio ice cream or pistachio nut ice cream is an ice cream flavor made with pistachio nuts or flavoring.' ],
